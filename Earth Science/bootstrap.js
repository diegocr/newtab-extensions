 ...
 * 
 * The Original Code is Earth Science NewTab Mozilla Extension.
 * 
...
function startup(aData, aReason) {
	...
	xhr.addEventListener('load',function(){
		if(xhr.status == 200) {
			let m = xhr.responseText.match(/<a class="asset-img-link".*? href="([^"]+-pi)"/),
	...
	xhr.open('GET', 'http://epod.usra.edu/', true);
	xhr.send();
}
