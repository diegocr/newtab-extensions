 ...
 * 
 * The Original Code is PaperWall NewTab Mozilla Extension.
 * 
...
function startup(aData, aReason) {
	...
	xhr.addEventListener('load',function(){
		if(xhr.status == 200) {
			let m = xhr.responseText.match(/<img src="image.php\?width[^"]+image=([^"]+\.(?:jpe?g|gif|png))"/),
	...
	xhr.open('GET', 'http://www.thepaperwall.com/', true);
	xhr.send();
}
